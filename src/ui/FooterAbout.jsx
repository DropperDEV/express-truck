export default function FooterAbout() {
  return (
    <div className=" mx-auto grid w-full grid-cols-3  bg-blue-1100 py-6">
      ...
      <div className=" flex flex-col  gap-3 text-center text-base">
      ...
      <div className=" flex flex-col items-center  justify-center gap-5 text-center text-base mb-9 ">
